...
```
python tools/PromptBkgHistMaker.py "/pnfs/desy.de/cms/tier2/store/user/sbein/NtupleHub/Production2016v2/Summer16.WJetsToLNu_HT-800To1200_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_25_RA2AnalysisTree.root"

python tools/PromptBkgHistMaker.py --fnamekeyword Summer16.WJetsToLNu_M-50_Tune 
```
...
```
python tools/SubmitJobs_fnal.py tools/PromptBkgHistMaker.py --fnamekeyword  Summer16.WJetsToLNu
```
...
You can also copy the necessary input files
